...
if use_lora:
    lora_config = LoraConfig(
        ...
        lora_dropout=0.1,
        bias="none",  # Changed from "lora_only" to avoid bitsandbytes
        task_type="CAUSAL_LM",
        inference_mode=False,
        init_lora_weights=True
    )
    
    # Prepare model for training without 8-bit quantization
    #moondream = prepare_model_for_kbit_training(
    #   moondream,
...
class ChessDataset(Dataset):
    def __init__(self, split="train"):
        self.dataset = load_dataset("vikhyatk/moondream2")
        self.split = split
        ...
        if (batch_idx + 1) % GRAD_ACCUM_STEPS == 0:
            ...
            if global_step % eval_steps == 0:
                ...
                if val_loss < best_val_loss:
                    ...
                    torch.save(
                        get_peft_model_state_dict(moondream),
