...
DTYPE = torch.float16  # Set DTYPE to float16
...
moondream = AutoModelForCausalLM.from_pretrained(
    ...
    torch_dtype=DTYPE,  # Set to float16
    cache_dir="./checkpoints/",
    device_map={"": DEVICE},
)
...
def compute_loss(batch):
    ...
    images = images.to(DEVICE, dtype=DTYPE)  # Ensure images are in float16
