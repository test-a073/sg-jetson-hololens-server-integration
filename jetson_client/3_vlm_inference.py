...
def get_answer(inference_device, image_path=image_path, query_text=query_text):
...
get_answer(inference_device = 0) # 0 : workstation (and finetuning the moondream)

print()
get_answer(inference_device = 1)
